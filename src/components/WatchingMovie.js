              ...
              <div className="grid grid-cols-2 h-[38px] w-[130px] bg-[#595959] items-center justify-center rounded-md">
                <button onClick={handleLike} className="w-full h-full">
                  <div className="flex items-stretch justify-center w-full h-full hover:bg-[#363636] pt-1.5 rounded-l-md">
                    <div className="">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-5 h-5 mr-2 mt-0.5">
                    ...
                    <div className="">
                      <p className="text-white text-base font-semibold">{likeCount}</p>
                    </div>
                  </div>
                </button>
                <button onClick={handleDislike} className="w-full h-full">
                  <div className="flex items-stretch justify-center w-full h-full pt-1.5 hover:bg-[#363636] rounded-r-md">
                    <div className="">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-5 h-5 mr-2 mt-1">
                    ...
                    <div className="">
                      <p className="text-white text-base font-semibold">{dislikeCount}</p>
                    </div>
                  </div>
                </button>
              </div>
        ...
        <div className="basis-2/5 ml-2 pr-4 pt-6 mt-6 pl-4 bg-[#4C4C4C] rounded-b-md">
          <div className="grid grid-cols-10 gap-4 mb-4">
            <div className="col-span-9">
              <input type="text" id="base-input" placeholder="Leave a comment as anonymous..." value={newComment} onChange={(e) => setNewComment(e.target.value)} className="border border-white text-white text-sm rounded-lg block w-full p-2.5 bg-[#4C4C4C] placeholder:text-white" />
            </div>
            <button onClick={handleCommentSubmit}>
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-auto h-auto">
          ...
          <div className="overflow-y-auto lg:h-[460px]">
            {comments.map((comment, index) => (
              <div className="grid grid-cols-1">
                <div key={index} className="bg-[#595959] mt-2 text-justify p-3 rounded-md">
